...
# from Metric.metric import get_raw_scores
from baidu_translator import baidu_translate
from question_context_match_BM25 import dispose
...
def evaluate():
    ...
    for index, example in enumerate(tqdm(examples)):
        ...
        context = dispose(
            text, example.question_text, all_sentences, embeddings_index, emb_size, bm25model,
            sentence_dict, 30)
    ...
    with open("./Metric/chinese-roberta-wwm-ext-finetuned-cmrc2018+BM25(Top30, t=2).json", "w") as f:
